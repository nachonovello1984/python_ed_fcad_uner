...
class Edge[T]:
    ...
    def __init__(self, u: Vertex[T], v: Vertex[T], x: T) -> None:
        self._origin = u
        self._destination = v
        self._element = x
    ...
    def endpoints(self) -> tuple[Vertex[T], Vertex[T]]:
        ...
        Returns:
            tuple[Vertex[T], Vertex[T]]: Devuelve el vértice origen y destino 
            en ese orden como una tupla.
        """
        return (self._origin, self._destination)
    
    def opposite(self, v: Vertex[T]) -> Vertex[T]:
        """ Devuelve el vértice correspondiente al otro extremo de la arista.

        Args:
            v (Vertex[T]): Si v es el vértice destino, devuelve el de origen.
            Caso contrario devuelve el de destino.

        Returns:
            Vertex[T]: vértice al otro extremo de la arista.
        """
