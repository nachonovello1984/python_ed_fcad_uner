...
class LinkedList[T]:
    ...
    def __init__(self) -> None:
        ...
        self._header: ListNode[T | None] = ListNode(None, None)
        self._size: int = 0
    ...
    def __contains__(self, item: T) -> bool:
        ...
        Args:
            item (T): el elemento a buscar en la estructura.
    ...
    def __getitem__(self, key: int) -> Optional[T]:
        ...
        Returns:
            T | None: Devuelve el valor almacenado por la posición indicada por key, caso contrario, None.
        """
        if self.is_empty():
        ...
        while actual:  # Si existe
            if i == key:  # Si el valor de i coincide con el de key
                return (
                    actual.element
                )  # Devuelvo el valor del nodo en el que estoy ubicado.
    ...
    def __setitem__(self, key: int, value: T) -> None:
        ...
        Args:
            ...
            value (T): nuevo elemento que va a ocupar la posición indicada por key.
    ...
    def __iter__(self) -> Iterable[T]:
        ...
        Yields:
            T: Devuelve el siguiente elemento de la lista cada vez que se lo solicita.
        """
    ...
    def append(self, elem: T) -> None:
        ...
        Args:
            elem (T): el elemento que va a quedar ubicado al final de la lista.
        """
    ...
    def index_of(self, elem: T) -> int:
        """Devuelve la ubicación elem en la estructura.

        Args:
            elem (T): El elemento a buscar.
